...
2. Prepare Amber/Sander DFTB3 QM/MM minimization and 200 ps equilibration inputs; prepare AmberTools ligand/protein topology inputs; then run relaxed scans or TS-search seeds only from this blind workflow.
