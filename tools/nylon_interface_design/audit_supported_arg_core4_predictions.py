...
r=Path(__file__).resolve().parent;o=r/'route6_supported_arg_core4_af20_v1'
out=r.parent/'n9_core_donor_design_20260910_gpu_outputs_v1/af2_route6_supported_arg_core4_20_v1'
...
for name,seq in queries.items():
 ...
 mean_CA_pLDDT=float(np.mean([v['CA'].bfactor for v in a])),TDD_backbone_RMSD_A=core_rms,core_and_support_backbone_RMSD_A=all_rms,
