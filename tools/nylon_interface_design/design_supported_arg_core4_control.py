...
name='supported_ARG_SC4559268_mpnn20_core4_v1'
...
assert hashlib.sha256(src.read_bytes()).hexdigest()=='bd6c4d376b4a950a3f1a22457dbb54dac40d162823d6015b5a2baad8d0e9ab54'
a={};rn={}
...
manifest={'status':'EXPLORATORY_NOT_GEOMETRY_PASS','source':str(src),'source_sha256':hashlib.sha256(src.read_bytes()).hexdigest(),'fixed':fixed,'opened_support_positions':[41,61,62,64,65],'comparison':'Same backbone and MPNN parameters; support Gly identities now designable','command':cmd,'known_defects':{'raw_self_close_pairs':9,'fixed_core_pairs':2,'omega_gt30':1},'output':str(out)}
