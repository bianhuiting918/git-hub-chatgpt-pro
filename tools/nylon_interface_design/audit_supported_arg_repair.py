...
r=Path.cwd().resolve();d=r/'route56_N10_20260915_v1';o=d/'route6_supported_ARG_SC4559268_v1';path=o/'fixed_core_repair_v1/after.pdb'
a={};elements={}
...
stamp=datetime.datetime.now(datetime.timezone.utc).strftime('%Y%m%dT%H%M%SZ');dest=o/'fixed_core_repair_v1'/('independent_audit_'+stamp+'.json')
