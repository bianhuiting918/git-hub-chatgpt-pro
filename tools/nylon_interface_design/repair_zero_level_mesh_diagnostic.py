...
o=b/'zero_level_mesh_repair_v1'/name;o.mkdir(parents=True,exist_ok=False)
...
meshes={};stats=[]
for lev in [0.,1e-6]:
 v,f,_,_=marching_cubes(field.astype(np.float32),lev,allow_degenerate=False);v-=32
...
out=r.parent/'n9_core_donor_design_20260910_gpu_outputs_v1/route6_zero_level_mesh_repair_v1'/name
