...
OUT=R/"pet_tangent_figures_all_sites_20260909_v2"
...
def main():
 ...
 with (R/"RUNBOOK.md").open("a") as f:f.write("\nPET tangent full-audit/figures: existing CPU Python pet_tangent_figures_all_sites_v2.py; output "+str(OUT)+". Use NEW OUT path to rerun; no edits to active all-material scan. Definitions/denominators/loose-tail limitations in README and summary.\n")
