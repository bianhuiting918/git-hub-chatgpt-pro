...
OUT=R/"pa66_tangent_figures_20260909_v1"
...
def main():
 ...
 with (R/"RUNBOOK.md").open("a") as f:f.write("\nPA66 tangent full-audit/figures: existing CPU Python pa66_tangent_figures_v1.py; output "+str(OUT)+". Use NEW OUT path to rerun; no edits to active all-material scan. Definitions/denominators/loose-tail limitations in README and summary.\n")
