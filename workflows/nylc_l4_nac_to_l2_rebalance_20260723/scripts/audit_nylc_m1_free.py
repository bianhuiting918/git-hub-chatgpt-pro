...
def main():
    ...
    if not numerical_pass:
        ...
        scientific="FAIL_UNRESTRAINED_M1_SEVERE_CONTACT"
    elif series["nac_frame_count"]>0:
        scientific="PASS_UNRESTRAINED_M1_NAC_PRESENT"
    else:
        scientific="FAIL_UNRESTRAINED_M1_NO_NAC"
    result={
      "schema_version":1,
      "candidate_id":"nylc_C18_trueT267_freeGS","microstate":"M1_NalphaH2_Asp306H",
      "slurm_job_id":args.job_id,
      "window_type":"fully_unrestrained_M1_NPT_1ns",
      ...
      "step1_qmmm_gate":"ELIGIBLE_FOR_M1_QMMM_PREFLIGHT" if scientific=="PASS_UNRESTRAINED_M1_NAC_PRESENT" else "NOT_ELIGIBLE_NO_FREE_L2_NAC",
    }
    (root/"m1_free_1ns_audit.json").write_text(json.dumps(result,indent=2,sort_keys=True)+"\n")
