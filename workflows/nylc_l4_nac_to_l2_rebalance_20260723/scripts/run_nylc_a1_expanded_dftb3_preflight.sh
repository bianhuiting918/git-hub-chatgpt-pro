...
CURRENT=one_step
srun -n "${SLURM_NTASKS:-1}" sander.MPI -O -i "$OUT/prepared/01_qmmm_one_step.in" -o "$OUT/prepared/01_qmmm_one_step.out" -p "$OUT/prepared/system.prmtop" -c "$OUT/prepared/representative_354ps.rst7" -r "$OUT/prepared/01_qmmm_one_step.rst7" -inf "$OUT/prepared/01_qmmm_one_step.mdinfo"
CURRENT=twenty_step
srun -n "${SLURM_NTASKS:-1}" sander.MPI -O -i "$OUT/prepared/02_qmmm_20_step.in" -o "$OUT/prepared/02_qmmm_20_step.out" -p "$OUT/prepared/system.prmtop" -c "$OUT/prepared/01_qmmm_one_step.rst7" -r "$OUT/prepared/02_qmmm_20_step.rst7" -inf "$OUT/prepared/02_qmmm_20_step.mdinfo"
